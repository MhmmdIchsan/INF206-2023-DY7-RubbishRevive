    ...
    <div class="container content-center')">
        <div class="flex flex-wrap ">
            <div class="w-full self-center px-4 text-center ">
                ...
                <h1 class="block font-normal text-slate-800 text-5xl mt-1 lg:text-5xl text-[#9ADCF1] underline py-3">On-Going
                    Transaction</h1>
                ...
                <div
                    ...
                    <div class="items-center px-5">
                        <form action="{{ route('pickup.destroy',$pickup->id) }}" method="POST">
                            <a class="btn btn-primary text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" href="{{ route('tukarpoin.edit',$pickup->id) }}">Terima</a>
                        </form>
                    </div>
                </div>
